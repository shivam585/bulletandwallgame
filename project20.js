...
if(damage1>200000&&gamestate==="result1"){
    ...
    strokeWeight("10")
    fill("yellow")
    text("rejected",400,140)
    shield1.shapeColor=("red")
